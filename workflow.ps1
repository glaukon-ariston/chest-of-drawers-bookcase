...
& $openscadPath -o "artifacts/model.png" --imgsize=600,1024 -D generate_cut_list_csv=false -D  export_panel_name='\"\"' -D generate_model_identifier=false -D generate_panel_names_list=false $modelPath
